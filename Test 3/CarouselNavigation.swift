//
//  CarouselNavigation.swift
//  Test 3
//
//  Created by Akın Özgen on 30.10.2020.
// Source: https://github.com/bbaars/SwiftUI-Image-Carousel

import SwiftUI
import Combine

struct CarouselNavigation<Content: View>: View {
...
struct CarouselNavigation_Previews: PreviewProvider {
    static var previews: some View {
        
        // 8
        GeometryReader { geometry in
            CarouselNavigation(numberOfImages: 3) {
